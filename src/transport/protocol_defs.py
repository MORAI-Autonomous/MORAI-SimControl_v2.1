...
MSG_TYPE_SHUTDOWN_SIMULATOR           = 0x1005
...
MSG_TYPE_DELETE_OBJECT                 = 0x1305
MSG_TYPE_GET_VEHICLE_INFO              = 0x1306
...
SIMULATOR_MODE_UNSPECIFIED = 0
SIMULATOR_MODE_SCENARIO    = 1
SIMULATOR_MODE_REPLAY      = 2
SIMULATOR_MODE_TRAFFIC     = 3
SIMULATOR_MODE_MONITORING  = 4
SIMULATOR_MODE_COMPETITION = 5

SIMULATOR_MODE_MAP = {
    SIMULATOR_MODE_UNSPECIFIED: "UNSPECIFIED",
    SIMULATOR_MODE_SCENARIO: "SCENARIO",
    SIMULATOR_MODE_REPLAY: "REPLAY",
    SIMULATOR_MODE_TRAFFIC: "TRAFFIC",
...
_RESP_1002 = get_response_message(0x1002)
_MSG_1003 = get_message(0x1003)
...
# --- Simulator Mode ---
GET_SIMULATOR_MODE_RESP_FMT  = build_struct_format(_RESP_1002.fields, LITTLE_ENDIAN)
GET_SIMULATOR_MODE_RESP_SIZE = struct.calcsize(GET_SIMULATOR_MODE_RESP_FMT)  # 12
SET_SIMULATOR_MODE_REQ_FMT  = build_struct_format(_MSG_1003.fields, LITTLE_ENDIAN)
SET_SIMULATOR_MODE_REQ_SIZE = struct.calcsize(SET_SIMULATOR_MODE_REQ_FMT)  # 4

# --- Simulation Status ---
GET_STATUS_FMT  = build_struct_format(_RESP_1101.fields, LITTLE_ENDIAN)
GET_STATUS_SIZE = struct.calcsize(GET_STATUS_FMT)   # 40

# --- Set Simulation Time Mode ---
SET_SIM_TIME_MODE_REQ_FMT  = build_struct_format(_MSG_1102.fields, LITTLE_ENDIAN)
SET_SIM_TIME_MODE_REQ_SIZE = struct.calcsize(SET_SIM_TIME_MODE_REQ_FMT)  # 20
...
# --- Get Vehicle Info ---
GET_VEHICLE_INFO_PREFIX_FMT = LITTLE_ENDIAN + "IIqiI"
GET_VEHICLE_INFO_PREFIX_SIZE = struct.calcsize(GET_VEHICLE_INFO_PREFIX_FMT)  # 24
GET_VEHICLE_INFO_VALUES_FMT = LITTLE_ENDIAN + "18f"
GET_VEHICLE_INFO_VALUES_SIZE = struct.calcsize(GET_VEHICLE_INFO_VALUES_FMT)  # 72
GET_VEHICLE_INFO_SUCCESS_BASE_SIZE = (
    GET_VEHICLE_INFO_PREFIX_SIZE + GET_VEHICLE_INFO_VALUES_SIZE
)  # 96 bytes plus entity_id
