...
def analyze_run(run_dir: str) -> Dict[str, Any]:
    ...
    if binary_noise_high and not overfiltered_no_ready:
    ...
    if shadow_noise_high and not overfiltered_no_ready:
    ...
    if p95_offset > 1.0 and not unstable_lane_run:
    ...
    elif violation_08m > 0.20 and not unstable_lane_run:
