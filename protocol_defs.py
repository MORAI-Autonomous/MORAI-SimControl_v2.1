...
MSG_TYPE_SET_TRAJECTORY_COMMAND = 0x1106
...
# =========================
# 0x1106 SetTrajectoryCommand payload
#
...
SET_TRAJECTORY_MIN_SIZE = (
    SET_TRAJECTORY_PREFIX_SIZE +        # entity_id_size
    SET_TRAJECTORY_FOLLOW_MODE_SIZE +   # follow_mode
    SET_TRAJECTORY_NAME_SIZE_SIZE +     # trajectory_name_size
    SET_TRAJECTORY_POINT_COUNT_SIZE     # point_count
)  # 16 (문자열 길이 0, point 0 기준)